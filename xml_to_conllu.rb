...
@upos_mappings = {"NN" => "NOUN", "PM" => "PROPN", "VB" => "VERB", "IE" => "PART", "PC" => "VERB", "PL" => "PART", "PN" => "PRON", "PS" => "DET", "HP"=> "PRON", "HS" => "DET", "DT" => "DET", "HD" => "DET", "JJ" => "ADJ", "AB" => "ADV", "HA" => "ADV", "KN" => "CONJ", "SN" => "SCONJ", "PP" => "ADP", "RG" => "NUM", "RO" => "ADJ", "IN" => "INTJ", "UO" => "X", "MAD" => "PUNCT", "MID" => "PUNCT", "PAD" => "PUNCT"}
